    ...
    return (
        <div className="flex justify-center text-center mx-5">
            <Tabs>
                ...
                <p className='max-w-4xl'>In this section, children can embark on exciting scientific adventures, conduct fun experiments, and learn about various scientific principles in an interactive and engaging way.</p>
